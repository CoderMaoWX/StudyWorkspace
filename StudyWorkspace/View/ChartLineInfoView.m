...
//  YDGJ
//
//  Created by mao wangxin on 16/9/20.
...
{
    //每一页绘图宽度
    CGFloat pageWidth = kScreenWidth - (SpaceWidth*2+LeftTextWidth);
...
-(UILabel *)scaleLabel{
    if (!_scaleLabel) {
        ...
        _scaleLabel.font = WX_FontSystem(14);
...
-(UILabel *)dateTimeLabel{
    if (!_dateTimeLabel) {
        ...
        _dateTimeLabel.font = WX_FontSystem(11);
